package com.mohit.todolist.ui.home
...
import com.mohit.todolist.adapter.ListAdapter
import com.mohit.todolist.databinding.FragmentHomeBinding
...
class HomeFragment : Fragment() {
    ...
    private fun setupRecyclerview() {
        ...
        binding.rvTodo.layoutManager = LinearLayoutManager(this.context)
        adapterTodo = ListAdapter(
            viewModel
        )
